...
import me.dolla.teamranked.commands.admin.games.GameInfoCommand;
...
public class RankedTeam {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        JDA jda = JDABuilder.createDefault(new PropertiesReader().getProperty("token"))
                ...
                .addEventListeners(new RegisterCommand(), new UnRegisterCommand(), new EloCommand(), new UpdateCommand(), new BotReady(), new QueueEloEvent(), new GameInfoCommand())
                .build().awaitReady();
